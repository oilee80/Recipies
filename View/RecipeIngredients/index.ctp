<div class="recipeIngredients index">
	<h2><?php echo __('Recipe Ingredients');?></h2>
	...
	<tr>
		...
		<td><?php echo h($recipeIngredient['RecipeIngredient']['quantity']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $recipeIngredient['RecipeIngredient']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $recipeIngredient['RecipeIngredient']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $recipeIngredient['RecipeIngredient']['id']), null, __('Are you sure you want to delete # %s?', $recipeIngredient['RecipeIngredient']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
